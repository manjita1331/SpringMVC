...
<form action="contactform" method="post">
	...
	Address* :     <input type="text" name = "address" required placeholder="Address"/><br/><br/>
	...
	Country* : <select name = "country" required>
		...
		Phone# :     <input class="phonenumber" name = "phoneno"  pattern="[0-9]{10}" maxlength=10 placeholder="Only numbers"/><br/><br/>
